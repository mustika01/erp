...
class OilJournalsROBChartWidget extends LineChartWidget
{
    ...
    protected static ?string $heading = 'Oil - R.O.B';
            ...
            'datasets' => [
                [
                    ...
                    'data' => $this->period->map(function (string $date) {
                        ...
                        return $journal ? $journal->rob_amount_type_90 : 0;
                    }),
                ...
                [
                    ...
                    'data' => $this->period->map(function (string $date) {
                        ...
                        return $journal ? $journal->rob_amount_type_40 : 0;
                    }),
                    'borderColor' => $this->period->map(function () {
                ...
                [
                    ...
                    'data' => $this->period->map(function (string $date) {
                        ...
                        return $journal ? $journal->rob_amount_type_10 : 0;
                    }),
                    'borderColor' => $this->period->map(function () {
