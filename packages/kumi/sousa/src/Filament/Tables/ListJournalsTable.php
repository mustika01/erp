...
use Kumi\Sousa\Filament\Resources\BunkerJournalResource\Tables\Actions as TableActions;
...
class ListJournalsTable extends Component implements Tables\Contracts\HasTable
{
    ...
    {
        return view('sousa::filament.tables.list-journals');
    }
    ...
    protected function getTableQuery(): Builder
    {
        ...
        return $this->bunker->journals()->getQuery()->latest('date');
    }
        ...
        return [
            ...
            Tables\Actions\ViewAction::make()
                ->url(function (Model $record) {
                    return BunkerJournalResource::getUrl('view', ['record' => $record]);
                })
                ->authorize(function (Model $record) {
                    return BunkerJournalResource::canView($record);
                }),
            Tables\Actions\EditAction::make()
                ->url(function (Model $record) {
                    return BunkerJournalResource::getUrl('edit', ['record' => $record]);
                })
                ->authorize(function (Model $record) {
            ...
            Tables\Actions\DeleteAction::make()
                ->authorize(function (Model $record) {
                    return BunkerJournalResource::canDelete($record);
                }),
        ];
    }
    ...
    {
        return fn (Model $record) => match (true) {
