...
class EditAdjustmentAction extends EditAction
{
    ...
    protected function setUp(): void
    {
        ...
        $this->label(__('norikumi::filament/resources/payout-item.actions.adjustments.edit.single.label'));

        $this->modalHeading(fn (): string => __('norikumi::filament/resources/payout-item.actions.adjustments.edit.single.modal.heading', ['label' => $this->getRecordTitle()]));

        $this->modalButton(__('norikumi::filament/resources/payout-item.actions.adjustments.edit.single.modal.actions.save.label'));

        $this->successNotificationMessage(__('norikumi::filament/resources/payout-item.actions.adjustments.edit.single.messages.saved'));
