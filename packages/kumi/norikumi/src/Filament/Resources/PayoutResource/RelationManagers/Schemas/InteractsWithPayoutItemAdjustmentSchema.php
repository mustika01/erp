...
trait InteractsWithPayoutItemAdjustmentSchema
{
            ...
            Forms\Components\Grid::make(4)
                ->schema([
                    Forms\Components\Select::make('type')
                        ->label(__('norikumi::filament/resources/payout-item.fields.type.label'))
                    ...
                    Forms\Components\TextInput::make('days_count')
                        ->label(__('norikumi::filament/resources/payout-item.fields.days_count.label'))
                        ->numeric()
                        ->default(0)
                        ->required()
                        ->rules(['not_in:0'])
    ...
    {
        return [
            PayoutItem::TYPE_ADJUSTMENT => __('norikumi::filament/resources/payout-item.fields.type.options.' . PayoutItem::TYPE_ADJUSTMENT),
            PayoutItem::TYPE_ATTENDANCE => __('norikumi::filament/resources/payout-item.fields.type.options.' . PayoutItem::TYPE_ATTENDANCE),
        ];
    }
}
