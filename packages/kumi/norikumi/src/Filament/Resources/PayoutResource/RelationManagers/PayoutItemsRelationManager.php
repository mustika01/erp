...
use Filament\Tables;
use Kumi\Norikumi\Filament\Resources\PayoutResource\RelationManagers\Tables\Actions as TableActions;
        ...
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('description')
                    ->label(__('norikumi::filament/resources/payout-item.columns.description.label')),
                Tables\Columns\TextColumn::make('amount_formatted')
                    ->label(__('norikumi::filament/resources/payout-item.columns.amount.label'))
                    ->alignRight()
            ...
            ->headerActions([
                ...
                TableActions\CreateDepositAction::make(),
            ])
            ->actions([
                ...
                TableActions\DeleteDepositAction::make(),
            ])
            ->bulkActions([
            ])
            ->defaultSort('id')
