...
trait InteractsWithPayoutItemLoanSchema
{
            ...
            Forms\Components\Grid::make(4)
                ->schema([
                    Forms\Components\TextInput::make('description')
                        ->label(__('jinzai::filament/resources/payout-item.fields.description.label'))
    ...
    {
        return [
            PayoutItem::TYPE_LOAN => __('jinzai::filament/resources/payout-item.fields.type.options.' . PayoutItem::TYPE_LOAN),
        ];
    }
}
