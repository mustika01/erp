    ...
    */
    ...
    'disks' => [
        ...
        'linode' => [
            ...
            'secret' => env('LINODE_S3_SECRET_KEY'),
        ...
        'airdrop' => [
            'driver' => 's3',
            'key' => env('AIRDROP_S3_ACCESS_KEY'),
            'secret' => env('AIRDROP_S3_SECRET_KEY'),
            'region' => env('AIRDROP_S3_REGION'),
            'bucket' => env('AIRDROP_S3_BUCKET'),
            'endpoint' => env('AIRDROP_S3_ENDPOINT'),
            // 'visibility' => 'public',
        ],
