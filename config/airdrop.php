    ...
    'triggers' => [
        ...
        FileTrigger::class => [
            ...
            'include' => [
                ...
                base_path('packages/kumi/tobira-kyoka-kensa/views'),
                base_path('packages/kumi/jinzai-kiosk/views'),
                base_path('packages/kumi/kanri/views'),
                base_path('packages/kumi/norikumi/views'),
                base_path('packages/kumi/sousa/views'),
            ],
